...
def peeling(node_dict, total_C_degree, total_q_degree, fib_heap, q, lambda1, lambda2):
    ...
    for i in range(n - 1):
        ...
        if i%50000 == 0:
            print(i, max_C_avg, q_avg, node_to_remove)
...
node_dict = process_tmdb_file("tmdb_2017.json")

# node_dict = process_dblp_file("dblp.json")
        ...
        while True:
            ...
            for node in node_dict.keys():
                ...
                for neighbor in node_dict[node].neighbor_dict.keys():
                    ...
                    #                     print(node_dict[node].neighbor_dict[neighbor])
